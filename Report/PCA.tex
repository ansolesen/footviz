...
\begin{figure}
\center
\includegraphics[scale=0.5]{"scree plot".pdf}
...
\begin{figure}
\center
\includegraphics[scale=0.7]{"PC1 Loadings".pdf}
...
\begin{figure}
\center
\includegraphics[scale=0.3]{"PC2 Loadings".pdf}
\includegraphics[scale=0.3]{"PC3 Loadings".pdf}
